...
The neighborhoods on the map are colored lighter as the number of total crime incidents increase. The colors in the stacked bar chart are used to differentiate the segments. We felt a darker color scheme was appropriate for the data subject matter. 
...
We spent about 25 hours developing the visualizations. The most time consuming parts were learning d3, reading the data in and mapping it to the correct visual structure, and linking the visualizations. 
